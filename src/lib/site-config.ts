...
export const siteConfigs: Record<string, SiteConfig> = {
  ...
  "investwithhacoco.com": {
    ...
    form: {
      ...
      description:
        "For direct buyers seeking matched real estate, land or Dubai market entry support.",
      submitLabel: "Get Curated Options",
      leadTag: "INV-LEAD",
      fields: [
        { name: "name", label: "Name", type: "text", required: true, placeholder: "Your full name" },
        { name: "email", label: "Email", type: "email", required: true, placeholder: "name@example.com" },
        ...
        },
        {
          ...
          type: "select",
          required: true,
          options: ["Self use", "Investment", "Rental income", "Land banking", "Company setup", "Mixed mandate"],
        },
        {
