...
- `GOOGLE_SITE_VERIFICATION_CAPITAL`, `GOOGLE_SITE_VERIFICATION_INVESTOR`, and `GOOGLE_SITE_VERIFICATION_ADVISORY` when Search Console provides HTML-tag tokens
- `BING_SITE_VERIFICATION_CAPITAL`, `BING_SITE_VERIFICATION_INVESTOR`, and `BING_SITE_VERIFICATION_ADVISORY` when Bing Webmaster Tools provides meta-tag tokens
